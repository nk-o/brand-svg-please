    ...
    class Brand_SVG_Please {
        ...
        public static function get_all_brands( $get_svg = false, $svg_data = array() ) {
            $brands = array(
                ...
                'bluesky'                   => esc_html__( 'Bluesky', 'bsp' ),
                ...
                'flutter'                   => esc_html__( 'Flutter', 'bsp' ),
                ...
                'pied-piper'                => esc_html__( 'Pied Piper', 'bsp' ),
                ...
                'shoelace'                  => esc_html__( 'Shoelace', 'bsp' ),
                'shopify'                   => esc_html__( 'Shopify', 'bsp' ),
                'shopware'                  => esc_html__( 'Shopware', 'bsp' ),
                'signal-messenger'          => esc_html__( 'Signal Messenger', 'bsp' ),
                ...
                'space-awesome'             => esc_html__( 'Space Awesome', 'bsp' ),
                ...
                'web-awesome'               => esc_html__( 'Web Awesome', 'bsp' ),
                'webflow'                   => esc_html__( 'Webflow', 'bsp' ),
                'wechat'                    => array(
